            ...
            <p className="mt-3 text-lg text-zinc-600 font-medium">
              ...
              {!isLoading && (
                <span className="text-zinc-500">
                  {' '}— найдено {total}{' '}
                  {total === 1 ? 'товар' : total >= 2 && total <= 4 ? 'товара' : 'товаров'}
                </span>
              )}
            </p>
          )}
      ...
      <AnimatePresence mode="wait">
        {isLoading ? (
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-zinc-300 bg-white shadow-sm py-32 text-center"
          >
            ...
            {totalPages > 1 && (
              <div className="mt-10 flex items-center justify-center gap-2">
                <button
                  ...
                  disabled={page <= 1}
                  className="p-2 rounded-xl bg-white shadow-sm ring-1 ring-zinc-200/50 text-zinc-500 hover:text-zinc-900 disabled:opacity-30 transition-colors"
                >
                  <ChevronLeft size={20} />
                </button>
                      ...
                      <button
                        ...
                        className={`w-10 h-10 rounded-xl text-sm font-bold transition-colors ${
                          page === p
                            ...
                            : 'bg-white text-zinc-700 shadow-sm ring-1 ring-zinc-200/50 hover:bg-zinc-50'
                        }`}
                      >
                        {p}
                      </button>
