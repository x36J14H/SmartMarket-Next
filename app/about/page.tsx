...
import { ShieldCheck, Truck, HeadphonesIcon, Award, Users, Globe, Sparkles, Database, CheckCircle2 } from 'lucide-react';
...
export default function AboutPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Прямая логистика 1С',
      description: 'Собственные склады и интеграция с ведущими курьерскими службами для доставки точно в срок.',
    },
    {
      icon: <HeadphonesIcon size={28} className="text-emerald-500" />,
      title: 'ИИ-Консультант 24/7',
      description: 'Симбиоз передового искусственного интеллекта и заботливой службы поддержки.',
    },
    {
        ...
        <div className="mx-auto max-w-[1440px] relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
              SmartMarket объединяет надежность складской учетной системы 1С:Предприятие,
              интеллектуальный поиск и честные цены без наценок площадок.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-4 text-zinc-600 font-normal leading-relaxed text-base">
              ...
              <p>
                В SmartMarket мы создали независимую инфраструктуру: товары бронируются непосредственно в 1С поставщика, за счёт чего покупатели получают лучшую цену на рынке, а заказы комплектуются и отправляются без промежуточных сортировочных очередей.
              </p>
            </div>
